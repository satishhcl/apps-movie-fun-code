...
public class CsvUtils {
    ...
    public static String readFile(String path) {
        try {
            ...
            InputStream fileStream=CsvUtils.class.getClassLoader().getResourceAsStream(path);

            System.out.println("full Path"+CsvUtils.class.getClassLoader().getResource(path).getPath());
